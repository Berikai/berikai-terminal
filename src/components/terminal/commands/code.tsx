...
export default terminal => ({
    ...
    execute: () => {
        ...
        const new_process = <BrowserWindow full={true} height={"[36rem]"} width={"[48rem]"} id={new_id} key={new_id}><iframe src="https://github1s.com/Berikai/terminal-emulator-sandbox" width="100%" height="100%"></iframe></BrowserWindow>
