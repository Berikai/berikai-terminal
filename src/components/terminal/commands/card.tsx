...
export default terminal => ({
    ...
    execute: () => {
        ...
        const new_process = <BrowserWindow height={'[52rem]'} weight={'[28rem]'} id={new_id} key={new_id}><iframe src="https://card.berikai.dev" width="100%" height="100%"></iframe></BrowserWindow>
